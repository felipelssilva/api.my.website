...
router
    .get("/", adminsController.isLoggedIn, (req, res) => {
        res.render(path.resolve(INDEX_VIEW_PATH), {
            user: req.user,
            page: "home",
        });
    })
    ...
    .get("/login", (req, res) => {
        res.render(path.resolve(INDEX_VIEW_PATH), { user: "", page: "login" });
    })
    ...
    .get("/logout", (req, res) => adminsController.logout(req, res));
